...
public class QPostScrap extends EntityPathBase<PostScrap> {
    ...
    private static final long serialVersionUID = -1683251731L;
    ...
    public final com.pharmquest.pharmquest.post.domain.QPost post;
    ...
    public QPostScrap(Class<? extends PostScrap> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.pharmquest.pharmquest.post.domain.QPost(forProperty("post"), inits.get("post")) : null;
