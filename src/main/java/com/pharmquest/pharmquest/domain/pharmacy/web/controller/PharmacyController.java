...
public class PharmacyController {
    ...
    public ApiResponse<Void> scrapPharmacy(@Parameter(hidden = true) @RequestHeader(value = "Authorization") String authorizationHeader
        ...
        SuccessStatus successStatus = pharmacyCommandService.scrapPharmacy(user, placeId);

        // scrap이 true면 스크랩 동작 성공, scrap이 false면 스크랩 취소 동작 성공
        return ApiResponse.noResultSuccess(successStatus);
    }
